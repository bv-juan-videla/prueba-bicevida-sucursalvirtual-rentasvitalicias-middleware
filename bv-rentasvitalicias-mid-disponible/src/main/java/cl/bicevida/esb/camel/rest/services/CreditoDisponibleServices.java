...
public class CreditoDisponibleServices {

	@GET
    @Path("/disponible/{rut}")
    public Response obtenerCreditoDisponible2(@PathParam("rut") String rut) {
        return null;
	}
	 
	@PUT
    @Path("/")
    public Response actualizarCreditoDisponible(CreditoDisponible datosCliente) {
        return null;
	}
